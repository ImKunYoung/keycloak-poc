...
import com.mycompany.myapp.repository.ViewRepository;
import com.mycompany.myapp.service.dto.ViewDTO;
import com.mycompany.myapp.service.mapper.ViewMapper;
...
class ViewResourceIT {
    ...
    void putWithMissingIdPathParamView() throws Exception {
        ...
        restViewMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(viewDTO))
            )
    ...
    void deleteView() throws Exception {
        ...
        // Delete the view
        restViewMockMvc
            .perform(delete(ENTITY_API_URL_ID, view.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
