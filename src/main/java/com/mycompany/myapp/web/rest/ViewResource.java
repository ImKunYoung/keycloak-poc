...
import com.mycompany.myapp.service.ViewService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.View}.
 */
@RestController
@RequestMapping("/api")
public class ViewResource {
    ...
    public ResponseEntity<ViewDTO> partialUpdateView(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, viewDTO.getId().toString())
        );
    }
