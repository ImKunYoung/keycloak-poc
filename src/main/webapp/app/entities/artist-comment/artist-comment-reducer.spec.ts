...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTISTCOMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTISTCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTISTCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTISTCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTISTCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTISTCOMMENT actions', async () => {
      const expectedActions = [
        {
