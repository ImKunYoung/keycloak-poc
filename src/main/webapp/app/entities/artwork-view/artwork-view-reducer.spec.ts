...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORKVIEW_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTWORKVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTWORKVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTWORKVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORKVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTWORKVIEW actions', async () => {
      const expectedActions = [
        {
