...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXHIBITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXHIBITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXHIBITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXHIBITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXHIBITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXHIBITION actions', async () => {
      const expectedActions = [
        {
