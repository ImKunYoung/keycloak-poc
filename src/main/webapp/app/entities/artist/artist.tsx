    ...
    <div>
      ...
      <div className="table-responsive">
        {artistList && artistList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('realName')}>
                  Real Name <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('voArtwork')}>
                  Vo Artwork <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {artistList.map((artist, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{artist.phone}</td>
                  <td>{artist.career}</td>
                  <td>{artist.voArtwork}</td>
                  <td>{artist.voMember}</td>
                  <td>{artist.status}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/artist/${artist.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">No Artists found</div>
        )}
      </div>
      {totalItems ? (
