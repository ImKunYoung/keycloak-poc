...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTISTLIKE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTISTLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTISTLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTISTLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTISTLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTISTLIKE actions', async () => {
      const expectedActions = [
        {
