...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './view.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIEW_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIEW actions', async () => {
      const expectedActions = [
        {
