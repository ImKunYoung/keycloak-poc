...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTISTVIEW_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTISTVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTISTVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTISTVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTISTVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTISTVIEW actions', async () => {
      const expectedActions = [
        {
